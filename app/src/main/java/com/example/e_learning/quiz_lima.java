...
public class quiz_lima extends AppCompatActivity {
    ...
    private quiz_lima.CounterClass mCountDownTimer;
    ...
    private static final String TAG = quiz_lima.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quiz_lima);
        db = new mapel_5(this);
    ...
    private void cler() {
        mCountDownTimer = new quiz_lima.CounterClass(detik, 1000);
...
//                rg.check(R.id.radio3);
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            tampilKotakAlert = new AlertDialog.Builder(quiz_lima.this).create();
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            noSalah="";
                            java.util.Arrays.fill(jawabanYgDiPilih, -2);
                            quiz_lima.this.tunjukanPertanyaan(0,
                                    cekPertanyaan);
                            nilai.setText(total);
                        }
                    });
            ...
            sendbio.enqueue(new Callback<BaseResponse>() {
                ...
                public void onResponse(Call<BaseResponse> call, Response<BaseResponse> response) {
                    ...
                    if (value.equals("1")) {
                        ...
                        Toast.makeText(quiz_lima.this, "berhasil", Toast.LENGTH_SHORT).show();
    ...
    void dialog_berhasil_simpan() {
        SweetAlertDialog pDialog = new SweetAlertDialog(quiz_lima.this, SweetAlertDialog.SUCCESS_TYPE);
        ...
        pDialog.setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
            ...
            public void onClick(SweetAlertDialog sweetAlertDialog) {
                ...
                Intent intent = new Intent(quiz_lima.this, menu_nilai.class);
