...
public class quiz_enam extends AppCompatActivity {
    ...
    private quiz_enam.CounterClass mCountDownTimer;
    ...
    private static final String TAG = quiz_enam.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quiz_enam);
        db = new mapel_6(this);
    ...
    private void cler() {
        mCountDownTimer = new quiz_enam.CounterClass(detik, 1000);
...
//                rg.check(R.id.radio3);
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            tampilKotakAlert = new AlertDialog.Builder(quiz_enam.this).create();
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            noSalah="";
                            java.util.Arrays.fill(jawabanYgDiPilih, -2);
                            quiz_enam.this.tunjukanPertanyaan(0,
                                    cekPertanyaan);
                            nilai.setText(total);
                        }
                    });
            ...
            sendbio.enqueue(new Callback<BaseResponse>() {
                ...
                public void onResponse(Call<BaseResponse> call, Response<BaseResponse> response) {
                    ...
                    if (value.equals("1")) {
                        ...
                        Toast.makeText(quiz_enam.this, "berhasil", Toast.LENGTH_SHORT).show();
    ...
    void dialog_berhasil_simpan() {
        SweetAlertDialog pDialog = new SweetAlertDialog(quiz_enam.this, SweetAlertDialog.SUCCESS_TYPE);
        ...
        pDialog.setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
            ...
            public void onClick(SweetAlertDialog sweetAlertDialog) {
                ...
                Intent intent = new Intent(quiz_enam.this, menu_nilai.class);
