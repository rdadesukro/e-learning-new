...
import com.example.e_learning.server.Pelayanan_service;
...
public class menu_profil_guru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menu_profil_guru);
        ...
        btn_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (pass_lama.getText().toString().equals("")) {
                    //  Toast.makeText(menu_profil_guru_pejabat_pejabat.this, "Password lama tidak boleh kosong", Toast.LENGTH_SHORT);
                    Toast.makeText(menu_profil_guru.this, "Password lama tidak boleh kosong", Toast.LENGTH_SHORT).show();

                    //  new GlideToast.makeToast(menu_profil_guru.this, "Password lama tidak boleh kosong", GlideToast.LENGTHLONG, GlideToast.WARNINGTOAST, GlideToast.BOTTOM).show();
                    pass_lama.requestFocus();
                } else if (pass_baru.getText().toString().trim().equals("")) {
                    Toast.makeText(menu_profil_guru.this, "Password baru tidak boleh kosong", Toast.LENGTH_SHORT).show();
                    // new GlideToast.makeToast(menu_profil_guru.this, "Password baru tidak boleh kosong", GlideToast.LENGTHLONG, GlideToast.WARNINGTOAST, GlideToast.BOTTOM).show();

                    // Toast.makeText(menu_profil_guru_pejabat_pejabat.this, "Password baru tidak boleh kosong", Toast.LENGTH_SHORT);
                    pass_baru.requestFocus();
                } else if (pass_baru2.getText().toString().trim().equals("")) {
                    Toast.makeText(menu_profil_guru.this, "Password konfirmasi tidak boleh kosong", Toast.LENGTH_SHORT).show();
                    //new GlideToast.makeToast(menu_profil_guru.this, "Password konfirmasi tidak boleh kosong", GlideToast.LENGTHLONG, GlideToast.WARNINGTOAST, GlideToast.BOTTOM).show();

                    //Toast.makeText(menu_profil_guru_pejabat_pejabat.this, "Password konfirmasi tidak boleh kosong", Toast.LENGTH_SHORT);
                    pass_baru2.requestFocus();
                } else if (!pass_baru.getText().toString().equals(pass_baru2.getText().toString())) {
                    Toast.makeText(menu_profil_guru.this, "pastikan password baru dan konfirmasi password sama !", Toast.LENGTH_SHORT).show();
                    // new GlideToast.makeToast(menu_profil_guru.this, "pastikan password baru dan konfirmasi password sama !", GlideToast.LENGTHLONG, GlideToast.WARNINGTOAST, GlideToast.BOTTOM).show();


                    // Toast.makeText(menu_profil_guru_pejabat_pejabat.this, "pastikan password baru dan konfirmasi password sama !", Toast.LENGTH_SHORT);
                    pass_baru2.requestFocus();
                } else if (pass_baru.getText().toString().trim().length() < 6) {
                    Toast.makeText(menu_profil_guru.this, "Minimal Password Baru 6 Karketr", Toast.LENGTH_SHORT).show();
                    //  Toast.makeText(menu_profil_guru_pejabat_pejabat.this, "Minimal Password Baru 6 Karketr", Toast.LENGTH_SHORT);
                    // new GlideToast.makeToast(menu_profil_guru.this, "Minimal Password Baru 6 Karketr", GlideToast.LENGTHLONG, GlideToast.WARNINGTOAST, GlideToast.BOTTOM).show();
    ...
    void btn_add() {
        ...
        Glide.with(menu_profil_guru.this)
        ...
        final CharSequence[] items = {"Camera", "Galeri",
                "Cancel"};
        AlertDialog.Builder builder = new AlertDialog.Builder(menu_profil_guru.this);
        ...
        builder.setTitle("Permissions required!")
                ...
                .setPositiveButton("GOTO SETTINGS", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        CameraUtils.openSettings(menu_profil_guru.this);
                    }
                })
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == SELECT_FILE && data != null && data.getData() != null) {
            try {
                ...
                bitmap = MediaStore.Images.Media.getBitmap(menu_profil_guru.this.getContentResolver(), data.getData());
    ...
    public void GET_profil() {
        ...
        Call<Response_profil> call = service.profil_guru(nis);
                ...
                try {
                    ...
                    if (data.size()==0){
                        ...
                        for (int i = 0; i < data.size(); i++) {
                            ...
                            txt_nis.setText(""+data.get(i).getNip());
                            foto=data.get(i).getFoto();
                            txt_kelas.setText(""+data.get(i).getNama_mapel());
    ...
    void edit_foto() {
        ...
        Call<BaseResponse> sendbio = api.edit_foto_guru(image, nis);
        ...
        sendbio.enqueue(new Callback<BaseResponse>() {
            ...
            public void onResponse(Call<BaseResponse> call, Response<BaseResponse> response) {
                ...
                //   progress.dismiss();
                if (value.equals("1")) {
                    Toast.makeText(menu_profil_guru.this, "Berhasil Edit Foto", Toast.LENGTH_SHORT).show();

                } else {
                    Toast.makeText(menu_profil_guru.this, "Gagal", Toast.LENGTH_SHORT).show();
    ...
    void updatepass() {
        ...
        Call<ResponsModel> update2 = api2.Update_pass_guru(
                nis,
        ...
        update2.enqueue(new Callback<ResponsModel>() {
            ...
            public void onResponse(Call<ResponsModel> call, Response<ResponsModel> response) {
                ...
                Toast.makeText(menu_profil_guru.this, "kode" + response.body().getKode(), Toast.LENGTH_SHORT);
                Log.i("kodeeee", "onResponse: "+response.body().getKode());
                if (response.body().getKode().equals("0")) {
                    Log.i("kodeeee", "onResponse: "+response.body().getKode());
                    // berhail();
                    Toast.makeText(menu_profil_guru.this, "Berhasil Ubah Password", Toast.LENGTH_SHORT).show();

                    dialog.dismiss();

                }
                if (response.body().getKode().equals("1")) {
                    Toast.makeText(menu_profil_guru.this, "Password Lama Salah", Toast.LENGTH_SHORT).show();
                    // Toast.makeText(menu_profil_guru_pejabat_pejabat.this, response.body().getPesan(), Toast.LENGTH_SHORT);
            ...
            public void onFailure(Call<ResponsModel> call, Throwable t) {
                ...
                //Toast.makeText(menu_profil_guru_pejabat.this, "gagal update", Toast.LENGTH_SHORT);
            }
        });
    }
