...
WHERE laporan.jenis_pengiriman IN ('twitter','instagram','facebook') AND laporan.status_laporan IN ('baru','tanggapan','selesai') AND masalah.id_kantor_dinas='$id_kantor_dinas' 
AND laporan.timer IN ('$timer','2')
