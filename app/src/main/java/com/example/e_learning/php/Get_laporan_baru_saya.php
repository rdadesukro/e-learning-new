...
$status_laporan=$_GET['status_laporan'];
 ...
 AND masalah.id_kantor_dinas=kantor_dinas.id_kantor_dinas WHERE laporan.status_laporan='$status_laporan' AND laporan.id_user='$id_user' GROUP BY id_laporan ORDER BY laporan.tanggal_lapor DESC";
