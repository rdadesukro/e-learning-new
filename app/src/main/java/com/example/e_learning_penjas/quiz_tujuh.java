...
public class quiz_tujuh extends AppCompatActivity {
    ...
    private quiz_tujuh.CounterClass mCountDownTimer;
    ...
    private static final String TAG = quiz_tujuh.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quiz_tujuh);
        db = new mapel_7(this);
    ...
    private void cler() {
        mCountDownTimer = new quiz_tujuh.CounterClass(detik, 1000);
...
//                rg.check(R.id.radio3);
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            tampilKotakAlert = new AlertDialog.Builder(quiz_tujuh.this).create();
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            noSalah="";
                            java.util.Arrays.fill(jawabanYgDiPilih, -2);
                            quiz_tujuh.this.tunjukanPertanyaan(0,
                                    cekPertanyaan);
                            nilai.setText(total);
                        }
                    });
            ...
            sendbio.enqueue(new Callback<BaseResponse>() {
                ...
                public void onResponse(Call<BaseResponse> call, Response<BaseResponse> response) {
                    ...
                    if (value.equals("1")) {
                        ...
                        Toast.makeText(quiz_tujuh.this, "berhasil", Toast.LENGTH_SHORT).show();
    ...
    void dialog_berhasil_simpan() {
        SweetAlertDialog pDialog = new SweetAlertDialog(quiz_tujuh.this, SweetAlertDialog.SUCCESS_TYPE);
        ...
        pDialog.setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
            ...
            public void onClick(SweetAlertDialog sweetAlertDialog) {
                ...
                Intent intent = new Intent(quiz_tujuh.this, menu_nilai.class);
