...
WHERE laporan.status_laporan IN ('selesai') AND masalah.id_kantor_dinas='$id_kantor_dinas'
...
LEFT JOIN masalah ON masalah.id_masalah=laporan.id_masalah
LEFT JOIN kantor_dinas ON masalah.id_kantor_dinas=kantor_dinas.id_kantor_dinas
WHERE laporan.status_laporan IN ('selesai')
...
LEFT JOIN masalah ON masalah.id_masalah=laporan.id_masalah
LEFT JOIN kantor_dinas ON masalah.id_kantor_dinas=kantor_dinas.id_kantor_dinas
WHERE laporan.status_laporan IN ('selesai') AND laporan.id_lokasi='$id_lokasi'
ORDER BY laporan.tanggal_selesai DESC";
}
...
LEFT JOIN kantor_dinas ON masalah.id_kantor_dinas=kantor_dinas.id_kantor_dinas
LEFT JOIN lokasi ON laporan.id_lokasi=lokasi.id_lokasi WHERE laporan.status_laporan IN ('selesai') AND lokasi.id_induk='$id_lokasi' ORDER BY laporan.tanggal_lapor DESC";
}
