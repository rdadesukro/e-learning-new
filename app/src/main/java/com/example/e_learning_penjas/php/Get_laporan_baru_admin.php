...
WHERE laporan.status_laporan IN ('baru','tanggapan','selesai') AND masalah.id_kantor_dinas='$id_kantor_dinas' AND laporan.jenis_pengiriman='sikesal' 
AND laporan.timer IN('0','1','2')
