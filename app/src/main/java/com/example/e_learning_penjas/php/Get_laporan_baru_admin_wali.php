...
laporan.pelapor,laporan.telp_pelapor,laporan.tanggapan_dinas,laporan.timer,
...
WHERE laporan.status_laporan IN ('baru','tanggapan','selesai') AND laporan.jenis_pengiriman='sikesal' AND laporan.timer='$timer'
