...
$id_lokasi=$_GET['id_lokasi'];
 ...
 $query = "SELECT laporan.id_laporan,laporan.id_user,user.nama_lengkap,kantor_dinas.kantor_dinas,masalah.masalah,
...
AND laporan.jenis_pengiriman IN ('koran') ORDER BY laporan.id_laporan DESC";
