...
public class DownloadTask {
    ...
    private class DownloadingTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog.setTitleText("Downlading....");
        ...
        protected void onPostExecute(Void result) {
            try {
                if (outputFile != null) {
                    ...
                    pDialog.setContentText("Document Downloaded Successfully ");
                    pDialog.setCancelable(false);
                    pDialog.setCancelButton("Open", new SweetAlertDialog.OnSweetClickListener() {
                        @Override
                        public void onClick(SweetAlertDialog sDialog) {
                            try {
                                ...
                                Log.i("data_file", "onClick: "+path);
//                            Intent intent = new Intent(context, menu_baca.class);
//                            Bundle b = new Bundle();
//                            b.putString("file", String.valueOf(path));
//                            intent.putExtras(b);
//                            context.startActivity(intent);
                                // new  Webview(context,path);
                                ...
                                try{
                                    ...
                                    Log.i("cek_error", "onClick: "+e);
                                    Toast.makeText(context, "No Application available to view PDF", Toast.LENGTH_SHORT).show();
                                }
                            }catch (Exception e){
                                Log.i("data", "onClick: "+e);
                            }
