...
import com.example.e_learning_penjas.adapter.adapter_vidio;
...
public class menu_vidio extends AppCompatActivity {
    private List<ResultItem_vidio> data = new ArrayList<>();
    adapter_vidio adapter;
...
//            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    public void get_laporan_selesai() {
        ...
        Call<Response_vidio> call = api.vidio();


        call.enqueue(new Callback<Response_vidio>() {
            @Override
            public void onResponse(Call<Response_vidio> call, Response<Response_vidio> response) {

                try {

                    data = response.body().getResult();
                    adapter = new adapter_vidio(menu_vidio.this,data);
                    ...
                    if (data.size()==0){
                        ...
                        Toast.makeText(menu_vidio.this, "Data Tidak Ada", Toast.LENGTH_SHORT).show();
            ...
            @Override
            public void onFailure(Call<Response_vidio> call, Throwable t) {
                t.printStackTrace();
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            startActivity(new Intent(menu_vidio.this, menu_utama.class));
            finish();
        }
