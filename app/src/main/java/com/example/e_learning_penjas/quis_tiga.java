...
public class quis_tiga extends AppCompatActivity {
    ...
    private quis_tiga.CounterClass mCountDownTimer;
    ...
    private static final String TAG = quis_tiga.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quis_tiga);
        db = new mapel_3(this);
    ...
    private void cler() {
        mCountDownTimer = new quis_tiga.CounterClass(detik, 1000);
...
//                rg.check(R.id.radio3);
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            tampilKotakAlert = new AlertDialog.Builder(quis_tiga.this).create();
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            noSalah="";
                            java.util.Arrays.fill(jawabanYgDiPilih, -2);
                            quis_tiga.this.tunjukanPertanyaan(0,
                                    cekPertanyaan);
                            nilai.setText(total);
                        }
                    });
            ...
            sendbio.enqueue(new Callback<BaseResponse>() {
                ...
                public void onResponse(Call<BaseResponse> call, Response<BaseResponse> response) {
                    ...
                    if (value.equals("1")) {
                        ...
                        Toast.makeText(quis_tiga.this, "berhasil", Toast.LENGTH_SHORT).show();
    ...
    void dialog_berhasil_simpan() {
        SweetAlertDialog pDialog = new SweetAlertDialog(quis_tiga.this, SweetAlertDialog.SUCCESS_TYPE);
        ...
        pDialog.setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
            ...
            public void onClick(SweetAlertDialog sweetAlertDialog) {
                ...
                Intent intent = new Intent(quis_tiga.this, menu_nilai.class);
