        ...
        btn_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (pass_lama.getText().toString().equals("")) {
                    ...
                    //  new GlideToast.makeToast(menu_profil_guru_admin.this, "Password lama tidak boleh kosong", GlideToast.LENGTHLONG, GlideToast.WARNINGTOAST, GlideToast.BOTTOM).show();
                    pass_lama.requestFocus();
                    ...
                    // new GlideToast.makeToast(menu_profil_guru_admin.this, "Password baru tidak boleh kosong", GlideToast.LENGTHLONG, GlideToast.WARNINGTOAST, GlideToast.BOTTOM).show();
                    ...
                    //new GlideToast.makeToast(menu_profil_guru_admin.this, "Password konfirmasi tidak boleh kosong", GlideToast.LENGTHLONG, GlideToast.WARNINGTOAST, GlideToast.BOTTOM).show();
                    ...
                    // new GlideToast.makeToast(menu_profil_guru_admin.this, "pastikan password baru dan konfirmasi password sama !", GlideToast.LENGTHLONG, GlideToast.WARNINGTOAST, GlideToast.BOTTOM).show();
                    ...
                    // new GlideToast.makeToast(menu_profil_guru_admin.this, "Minimal Password Baru 6 Karketr", GlideToast.LENGTHLONG, GlideToast.WARNINGTOAST, GlideToast.BOTTOM).show();
